...
public class BarChartRenderer extends BarLineScatterCandleBubbleRenderer {
    ...
    private boolean shapeType = false;

    private float roundRect = 0;
    ...
    public BarChartRenderer(BarDataProvider chart, ChartAnimator animator,
                            ViewPortHandler viewPortHandler,boolean shapeType,float roundRect) {
        ...
        Log.e("lc","BarChartRenderer");
        Log.e("lc","shapeType:" + shapeType + ", roundRect:" + roundRect);
    }
    ...
    protected void drawDataSet(Canvas c, IBarDataSet dataSet, int index) {
        ...
        if (mChart.isDrawBarShadowEnabled()) {
            ...
            for (int i = 0, count = Math.min((int)(Math.ceil((float)(dataSet.getEntryCount()) * phaseX)), dataSet.getEntryCount());
                ...
                if (!shapeType){
                    ...
                    Log.e("lc","shadow rect1");
                }else {
                    c.drawRoundRect(mBarShadowRectBuffer,roundRect,roundRect, mShadowPaint);
                    Log.e("lc","shadow rectRound1");
                }
            }
        }
        ...
        for (int j = 0; j < buffer.size(); j += 4) {
            ...
            if (!shapeType){
                ...
                Log.e("lc","shadow rect2");
            }else {
                c.drawRoundRect(buffer.buffer[j], buffer.buffer[j + 1], buffer.buffer[j + 2],
                        buffer.buffer[j + 3],roundRect,roundRect,mRenderPaint);
                Log.e("lc","shadow rectRound2");
            }
            ...
            if (drawBorder) {
                if (!shapeType){
                    ...
                    Log.e("lc","shadow rect3");

                }else {
                    c.drawRoundRect(buffer.buffer[j], buffer.buffer[j + 1], buffer.buffer[j + 2],
                            buffer.buffer[j + 3],roundRect,roundRect, mBarBorderPaint);
                    Log.e("lc","shadow rectRound3");
                }
    ...
    protected void prepareBarHighlight(float x, float y1, float y2, float barWidthHalf, Transformer trans) {
        ...
        if (!shapeType){
            ...
            Log.e("lc","shadow rect4");
        }else {
            trans.rectToPixelPhase(mBarRect, mAnimator.getPhaseY());
            Log.e("lc","shadow rectRound4");
    ...
    public void drawHighlighted(Canvas c, Highlight[] indices) {
        ...
        for (Highlight high : indices) {
            ...
            if (!shapeType){
                ...
                Log.e("lc","shadow rect5");

            }else {
                c.drawRoundRect(mBarRect,roundRect,roundRect,mHighlightPaint);
                Log.e("lc","shadow rectRound5");
