 ...
 */
public class BarRoundChart extends BarLineChartBase<BarData> implements BarDataProvider {
    ...
    public BarRoundChart(Context context) {
        super(context);
    }

    public BarRoundChart(Context context, AttributeSet attrs) {
        super(context, attrs);
    }

    public BarRoundChart(Context context, AttributeSet attrs, int defStyle) {
    ...
    protected void init() {
        ...
        mRenderer = new BarChartRenderer(this, mAnimator, mViewPortHandler, true, 20);
