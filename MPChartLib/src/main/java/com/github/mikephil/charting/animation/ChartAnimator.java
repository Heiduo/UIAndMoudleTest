...
public class ChartAnimator {
    ...
    @RequiresApi(11)
    private ObjectAnimator yAnimator(int duration, EasingFunction easing,String animation) {
        ObjectAnimator animator = ObjectAnimator.ofFloat(this,"alpha",0,1,1);
    ...
    @RequiresApi(11)
    public void animateY(int durationMillis, EasingFunction easing,String animation) {

        ObjectAnimator animatorY = yAnimator(durationMillis, easing,animation);
        animatorY.addUpdateListener(mListener);
        animatorY.start();
    }
